<?php include 'header.php'; ?>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-5 order-3 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            <div class="text-slider active">
              <h1>Better Solutions For Your Home</h1>
              <p>We can make your dream home</p>
            </div>
            <div class="text-slider">
              <h1>Modern Design for Living</h1>
              <p>Professional solutions for every room</p>
            </div>
            <div class="text-slider">
              <h1>Make Your Space Perfect</h1>
              <p>Decorate with the best materials</p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="content" data-aos="fade-up" data-aos-delay="100">
            <p>
              Rensa Wallpaper mengutamakan kepuasan belanja konsumennya, selain menyediakan beberapa kebutuhan konsumen yang ready 
              stock dengan harga produk yang sangat terjangkau dan orang-orang profesional dibidangnya, kami pun sangat memperhatikan kenyamanan konsumen dalam melakukan aktifitas belanja di toko-toko kami.
            </p>
            
              <ul>
                <li><i class="bi bi-check2-circle"></i> <span><b>Terpercaya selama 12 tahun.</b></span></li>
                <li><i class="bi bi-check2-circle"></i> <span><b>Terbaik dalam kualitas</b></span></li>
                <li><i class="bi bi-check2-circle"></i> <span><b>Terbesar se indonesia</b></span></li>
              </ul>
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center order-2 order-lg-3">
            ...
            <div class="faq-container px-xl-5" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="faq-item ">
                ...
                <h3><span>01</span> Stok barang bandung</h3>
                <div class="faq-content">
                  <p>Stok barang bandung banyak.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3><span>02</span> Pemasangan rapih dan cepat</h3>
                <div class="faq-content">
              ...
              <div class="faq-item">
                <h3><span>03</span> Barang Berkualitas dan Desain timeless</h3>
                <div class="faq-content">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              <img class="icon" src="assets/img/icon/pasang.png" alt="">
              <h4><a href="" class="stretched-link">Pemasangan</a></h4>
              <p>Kami menyediakan pemasangan untuk daerah daerah sekitar toko</p>
            </div>
          </div><!-- End Service Item -->

          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              <img class="icon" src="assets/img/icon/kirim.png" alt="">
              <h4><a href="" class="stretched-link">Pengiriman Ke user</a></h4>
              <p>Kami menyediakan pengiriman langsung kepada user</p>
            </div>
          </div><!-- End Service Item -->

          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item position-relative">
              <img class="icon" src="assets/img/icon/konsul.png" alt="">
              <h4><a href="" class="stretched-link">Konsultasi Decor</a></h4>
              <p>Kami menyediakan konsultasi desain dan product yang sesuai untuk dipakai dirumah anda</p>
            </div>
          </div><!-- End Service Item -->

          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item position-relative">
              <img class="icon" src="assets/img/icon/desain.png" alt="">
              <h4><a href="" class="stretched-link">Desain 3D</a></h4>
              <p>Kami menyediakan desain 3D menggunakan skecth up untuk user sesuai dengan bentuk bidang dan product yang akan dipasang.</p>
            </div>
          </div><!-- End Service Item -->
      ...
      <div class="container">
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
            ...
            <li data-filter=".filter-wall">Wall panel (Wpc)</li>
            <li data-filter=".filter-flooring">Flooring Decor</li>
            <li data-filter=".filter-wallboard">Wallboard</li>
            <li data-filter=".filter-uvm">UV Marble</li>
            <li data-filter=".filter-acc">Aksesoris</li>
            <li data-filter=".filter-pasang">Pemasangan</li>
          ...
          <div class="col-lg-10">
            ...
            <div class="faq-container">
              ...
              <div class="faq-item faq-active" data-aos="fade-up" data-aos-delay="200">
                ...
                <h3> Apa itu Rensa.id?</h3>
                <div class="faq-content">
                  <p>Rensa.id adalah perusahaan yang bergerak di bidang interior dan dekorasi, khususnya dalam penyediaan wallpaper, wallpanel, lantai vinyl, dan berbagai produk terkait lainnya. Kami berkomitmen untuk menyediakan produk berkualitas tinggi dengan harga terjangkau untuk mempercantik ruangan Anda.
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->
              ...
              <div class="faq-item" data-aos="fade-up" data-aos-delay="300">
                <i class="faq-icon bi bi-question-circle"></i>
                <h3>Produk apa saja yang ditawarkan oleh Rensa.id?</h3>
                <div class="faq-content">
                  <p>Kami menawarkan berbagai produk interior dan dekorasi, antara lain:

                    <b>Wallpaper</b>,
                    <b>Wallpanel & WPC Panel</b>,
                    <b>SPC & Vinyl Flooring</b>,
                    <b>UV Board/PVC Board</b>,
                    <b>Kisi-Kisi & Wall Moulding</b>,
                    <b>Curtain Blinds Sandblast</b>,
                    <b>Outdoor WPC & PU Stone</b>,
                    <b>Decking & Grass</b></p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->
              ...
              <div class="faq-item" data-aos="fade-up" data-aos-delay="400">
                <i class="faq-icon bi bi-question-circle"></i>
                <h3>Apakah Rensa.id melayani pengiriman ke luar kota Bandung?</h3>
                <div class="faq-content">
                  <p>Ya, kami melayani pengiriman ke berbagai kota di Indonesia. Biaya dan estimasi waktu pengiriman akan disesuaikan dengan lokasi tujuan. Untuk informasi lebih lanjut, silakan hubungi customer service kami di 0815 4600 4444.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->
              ...
              <div class="faq-item" data-aos="fade-up" data-aos-delay="500">
                <i class="faq-icon bi bi-question-circle"></i>
                <h3>Apakah Rensa.id menerima pembayaran dengan kartu kredit?</h3>
                <div class="faq-content">
                  <p>Ya, kami menerima pembayaran dengan kartu kredit melalui sistem pembayaran yang tersedia di website kami. Selain itu, kami juga menerima pembayaran melalui transfer bank dan metode pembayaran lainnya.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->
          ...
          <div class="col-lg-5">
            ...
            <div class="info-wrap">
              <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="200">
                ...
                <div>
                  <h3>Address</h3>
                  <p>Jl. Baros No.52, Leuwigajah, Kec. Cimahi Sel., Kota Cimahi, Jawa Barat 40521</p>
                </div>
              </div><!-- End Info Item -->
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.946597105098!2d107.53380797573926!3d-6.896991067495545!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e58b14dbdbe5%3A0xbf4ac8437c9d8527!2sToko%20Wallpaper%20Rensa%20Baros%20Office!5e0!3m2!1sid!2sid!4v1737008797629!5m2!1sid!2sid" frameborder="0" style="border:0; width: 100%; height: 270px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
