        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper align-items-center" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="swiper-slide isotope-item portfolio-item filter-branding ">
                  <a href="assets/img/pemasangan/2.jpg" title="Product 1" class="glightbox preview-link">
                  <img src="assets/img/pemasangan/2.jpg" alt="" class="img-fluid">
                  </i></a>
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              ...
              <ul>
                <li><strong>Category</strong>: Pemasangan</li>
